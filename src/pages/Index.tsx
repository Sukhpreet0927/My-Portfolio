  ...
  useEffect(() => {
    const handleScroll = () => {
      if (contactSectionRef.current) {
        ...
        const visibleHeight = Math.max(0, Math.min(sectionHeight, windowHeight - rect.top));
                ...
                <div className="relative flex flex-col md:flex-row md:items-center">
                  <div className="md:w-1/2 md:pr-8">
                    <div className="bg-card border border-border rounded-lg p-6 shadow-cultural hover:shadow-elegant transition-all duration-300">
                      ...
                      <p className="text-muted-foreground leading-relaxed mb-4">
                        Worked with Professor Matthew Butner and a team of six to develop <span className="font-medium text-foreground">Equigrade</span>, a Python program that allows for grade substitution and
    ...
    {project === 1 ? (
      ...
      >
        <img
          ...
          className="w-full h-48 object-cover rounded-lg mb-10 mt-10"
        />
        ...
        <div className="flex gap-2 flex-wrap">
          <span className="px-3 py-1 bg-primary/20 text-primary rounded-full text-sm">SwiftUI</span>
          <span className="px-3 py-1 bg-secondary/20 text-secondary rounded-full text-sm">ActivityKit</span>
          <span className="px-3 py-1 bg-accent/20 text-accent rounded-full text-sm">WidgetKit</span>
          <span className="px-3 py-1 bg-yellow-300/20 text-yellow-300 rounded-full text-sm">Firebase</span>
          <span className="px-3 py-1 bg-pink-400/20 text-pink-400 rounded-full text-sm">CoreImage</span>
          <span className="px-3 py-1 bg-purple-500/20 text-purple-500 rounded-full text-sm">CodeScanner</span>
        </div>
      </a>
    ) : project === 2 ? (
      <a
      ...
      >
        ...
        <div className="flex gap-2 flex-wrap">
          <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-sm">Claude Opus 4</span>
          <span className="px-3 py-1 bg-secondary/10 text-secondary rounded-full text-sm">Vapi</span>
          <span className="px-3 py-1 bg-pink-400/20 text-pink-400 rounded-full text-sm">React Native</span>
          <span className="px-3 py-1 bg-yellow-300/20 text-yellow-300 rounded-full text-sm">FastAPI</span>
          <span className="px-3 py-1 bg-purple-500/20 text-purple-500 rounded-full text-sm">Firebase</span>
          <span className="px-3 py-1 bg-accent/10 text-accent rounded-full text-sm">Supabase</span>
          <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-sm">Tailwind CSS</span>
        </div>
      </a>
    ) : (
      <a
        href="https://devpost.com/software/safedose"
        target="_blank"
        rel="noopener noreferrer"
        className="block hover:opacity-90 transition-opacity"
      >
        ...
        <p className="text-muted-foreground mb-4">
        SafeDose helps people monitor their opioid intake by allowing users to log their medication intake. 
        SafeDose charts their dosage intake over a week time interval and notifies users if they have taken a higher dosage than the recommended amount. 
        Users can also log their symptoms if they experience any symptoms of an opioid overdose, and SafeDose will recommend them to see a doctor based on what they report.


        </p>
        <div className="flex gap-2 flex-wrap">
          <span className="px-3 py-1 bg-primary/20 text-primary rounded-full text-sm">SwiftUI</span>
          <span className="px-3 py-1 bg-secondary/20 text-secondary rounded-full text-sm">Vision</span>
          <span className="px-3 py-1 bg-accent/20 text-accent rounded-full text-sm">SwiftCharts</span>
          <span className="px-3 py-1 bg-amber-400/20 text-amber-400 rounded-full text-sm">Firebase</span>
        </div>
      </a>
    )}
  </div>
        ...
        >
          ...
          {/* Black Overlay with Contact Info */}
          <div 
            className="absolute inset-0 bg-contact-dark transition-opacity duration-500 flex items-center justify-center"
            style={{
              opacity: Math.max(0, (scrollProgress - 0.6) * 2),
            }}
          >
            <div className="max-w-4xl mx-auto text-center px-4">
              ...
              <p className="text-contact-light text-lg mb-12 max-w-2xl mx-auto">
                Let's collaborate on something amazing. Whether you have a project in mind or just want to connect, I'd love to hear from you.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <a
                  href="mailto:sukhpreetaulakh002@gmail.com"
                ...
                <a
                  href="https://github.com/Sukhpreet0927"
                  className="inline-flex items-center justify-center px-8 py-4 bg-gradient-primary text-primary-foreground rounded-lg font-semibold hover:opacity-90 transition-opacity"
                >
                  Connect on Github
                </a>
